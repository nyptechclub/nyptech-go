...
export default function Page() {
  return (
    <main className={"h-full flex items-center justify-center"}>
      <div className={"text-center flex flex-col container break-words w-96 m-5 md:w-full"}>
        <img
          className={"mb-4 size-[200px] mx-auto"}
          src={"https://nyptech.vercel.app/favicon.ico"}
          alt={"Icon"}
        />
        <h1 className={"text-2xl font-bold break-words m-5"}>NYP Technopreneurship Club</h1>
